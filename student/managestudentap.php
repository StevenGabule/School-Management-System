...
$query3 = " 
			SELECT * from tblacctspayable where sap_id = '$s_id' 
		";      
		try 
		{ 
...
<body>
    ...
    <div class="responsive-navigation visible-sm visible-xs">
        ...
        <div class="responsive-menu">
            <ul>
                <li class="home"><a href="index.php"><span style="padding-right:20px;"><img src="images/grades.png"></span>Grades</a></li>
	            <li class"about"><a href=" managestudentap.php"><span style="padding-right:20px;"><img src="images/invoice.png"></span>Invoice</a></li>
	            <li class="services"><a href="./../logout.php"><span style="padding-right:20px;"><img src="images/exit.png"></span>Logout</a></li>
            </ul> <!-- /.main_menu -->
        </div> <!-- /.responsive_menu -->
	...
	<div id="main-sidebar" class="hidden-xs hidden-sm">
		<div class="logo">
			<a href="index.php" rel="nofollow"><h1>STUDENT PANEL</h1></a>
						...
						<table class="table table-striped" id="resultTable">                            
                            ...
                            <tbody>
									<?php foreach($rows3 as $row3): ?>                                	
                                        <tr> 
                                            <td><?php echo htmlentities($row3['datep'], ENT_QUOTES, 'UTF-8'); ?></td> 
                                            <td><?php echo htmlentities($row3['seriesno'], ENT_QUOTES, 'UTF-8'); ?></td> 
                                            <td><?php echo htmlentities($row3['stabno'], ENT_QUOTES, 'UTF-8'); ?></td> 
                                            <td><?php echo htmlentities($row3['regfee'], ENT_QUOTES, 'UTF-8'); ?></td> 
                                            <td><?php echo htmlentities($row3['tuition'], ENT_QUOTES, 'UTF-8'); ?></td> 
                                            <td><?php echo htmlentities($row3['subtotal'], ENT_QUOTES, 'UTF-8'); ?></td> 
                                            <td><?php echo htmlentities($row3['remarks'], ENT_QUOTES, 'UTF-8'); ?></td> 
