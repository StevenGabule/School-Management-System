	...
	<div id="main-sidebar" class="hidden-xs hidden-sm">
		...
		<div>
	        <ul class="main-menu">
	            ...
	            <li class="portfolio"><a href="Teacher.php"><span style="padding-right:20px;"><img src="images/teacher.png"></span>Teacher</a></li>
	            <li class="about"><a href="Settings.php"><span style="padding-right:20px;"><img src="images/settings.png"></span>Settings</a></li>
