...
$s_id = $_GET['id'];
$query = " 
			SELECT a.*, b.* FROM tblstudent a INNER JOIN tblsection b on a.sec_id = b.sec_id where a.s_id = '$s_id' 
		";  
		...
		<div class="container-fluid">
            <div id="about" class="section-content">
				<div class="row">
                    ...
                    <div class="row add-form">  <?php foreach($rows as $row): ?>             
                        <form id='register' action='editstudent_reg.php' method='post'>                    
                        ...
                        <div class="row add-form">	
                                <div class="col-md-2">
                                    ...
                                    <br />	
                                     <input name="bdate" type="date" value="<?php echo $row['bdate'];?>">
                                </div> <!-- /.col-md-2 -->
                                <div class="row add-form"> 
                                <div class="col-md-3">
                                ...
                                <label for="sec_id" class="required">Select Section</label>    <br />      
                                    <select name="sec_id" class="col-md-3">
                                        ...
                                        <option value="<?php echo $row1['sec_id'] ?>" /> <?php echo $row1['secdes'] ?> <?php echo $row['secyear'] ?></option>
                                        <?php endforeach; ?>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input name="cno" type="text" value="<?php echo $row['contactno'];?>">
                                </div> <!-- /.col-md-3 -->
                                <div class="col-md-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="col-md-5" name="address"  rows="3"><?php echo $row['address'];?></textarea>
                                </div> <!-- /.col-md-12 -->
                                 <div class="col-md-3"><br />
                                <label for="fathername" class="required">Father's Name:</label>
                                <input name="fathername" type="text" value="<?php echo $row['fatherName'];?>">
                            </div> <!-- /.col-md-3 -->
                            <div class="col-md-3"><br />
                                <label for="mothername" class="required">Mother's Name:</label>
                                <input name="mothername" type="text" value="<?php echo $row['motherName'];?>">
                            </div> <!-- /.col-md-3 --> 
