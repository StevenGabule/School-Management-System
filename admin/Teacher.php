						...
						<table class="table table-striped" id="resultTable">                            
							...
							<?php
                                ...
                                $sql = "SELECT 
									...
									echo "<td> " . $row["cnum"] . "</td>";
									echo "<td> " . '<a href="manageteacher.php?id=' . $row["t_id"] . '">' . "Manage" . "</td>";								
									echo "<td> " . '<a href="delteacher.php?id=' . $row["t_id"] . '">' . "Delete" . "</td>";									
									echo "</tr>";
									}
                                ?>
                            </tbody>
                            ...
                            <div class="row">
                                <div class="col-md-3 ">
                                <a href="<?php echo "addteacher.php?id=" . $row["t_id"];?>" class="submit-btn largeButton contactBgColor">Add Teacher</a>
                                </div> <!-- /.col-md-3 -->
                            </div> <!-- /.row-->
					</div>
			</div> <!-- /#about -->
