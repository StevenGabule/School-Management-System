						...
						<table class="table table-striped" id="resultTable">                            
							...
							<?php
                                ...
                                $sql = "SELECT 
												...
												inner join 
												tblcenter on 
												tblcenter.c_id = tblstudent.center_id
										";
									...
									echo "<td> " . '<a href="managestudent.php?id=' . $row["s_id"] . '">' . "Manage" . "</td>";								
									echo "<td> " . '<a href="deleteStd.php?id=' . $row["id"] . '">' . "Delete" . "</td>";									
									echo "</tr>";
									}
                                ?>
                            </tbody>
                            ...
                            <div class="row">
                                <div class="col-md-3 ">
                                <a href="addstudent.php" class="submit-btn largeButton adstdBgColor">Add Student</a>
                                </div> <!-- /.col-md-3 -->
                            </div> <!-- /.row-->
					</div>
			</div> <!-- /#about -->
                 ...
                 <div class="row contact-form">   
					<div class="col-md-4">
						...
						<div class="col-md-2 ">
                            ...
                            <input type="hidden" class="submit-btn largeButton adstdBgColor" value="Login" />
						</div> <!-- /.col-md-2 -->
                   </form>
				</div>
			</div> <!-- /#account -->
